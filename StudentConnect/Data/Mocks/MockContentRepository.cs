...
namespace StudentConnect.Data.Mocks
{
    ...
    public class MockContentRepository : IContentRepository 
    {
        ...
        {
            yield return new Person { DisplayOrder = 1, Name = "Betsy Garcia", Title = "HR Director", MoreInfo = "", BioLink = "", ImageUrl = "" };
            yield return new Person { DisplayOrder = 2, Name = "Glenn Ferrie", Title = "Practice Manager", MoreInfo = "", BioLink = "", ImageUrl = "" };
            yield return new Person { DisplayOrder = 3, Name = "James Idoni", Title = "Project Manager", MoreInfo = "", BioLink = "", ImageUrl = "" };
            yield return new Person { DisplayOrder = 3, Name = "Kishore Joshi", Title = "Software Dev", MoreInfo = "", BioLink = "", ImageUrl = "" };
        }
    }
}